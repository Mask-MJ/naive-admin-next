import type { ConfigList } from './types/config';
...
// 查询参数列表
export const getConfigList = (params) => defHttp.get<ConfigList>({ url: Api.ListConfig, params });
// 刷新缓存
...
// 新增参数配置
export const addConfig = (params) => defHttp.post({ url: Api.SetConfig, params });
// 修改参数配置
export const updateConfig = (params) => defHttp.put({ url: Api.SetConfig, params });
// 删除参数配置
