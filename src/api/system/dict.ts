...
// 获取字典列表
export const getDictList = (params) => defHttp.get({ url: Api.DictList, params });
// 刷新缓存
...
// 新增字典列
export const addDictList = (params) => defHttp.post({ url: Api.setDictList, params });
// 修改字典列
export const editDictList = (params) => defHttp.put({ url: Api.setDictList, params });

// 获取字典数据列表
export const getDictDataList = (params) => defHttp.get({ url: Api.DictDataList, params });
// 字典数据详情
...
// 新增字典数据列
export const addDictDataList = (params) => defHttp.post({ url: Api.DictDetail, params });
// 修改字典数据列
export const editDictDataList = (params) => defHttp.put({ url: Api.DictDetail, params });
