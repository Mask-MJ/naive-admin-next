  ...
  const options = computed<Option[]>(() => [
    {
      ...
      icon: () => h('i', { class: 'icon-ant-design:reload-outlined' }),
    },
    {
      label: '关闭',
      key: 'close-current',
      disabled: props.currentPath === tab.homeTab.fullPath || Boolean(props.affix),
      icon: () => h('i', { class: 'icon-ant-design:close-outlined' }),
    },
    {
      label: '关闭其他',
      key: 'close-other',
      icon: () => h('i', { class: 'icon-ant-design:column-width-outlined' }),
    },
    {
      label: '关闭左侧',
      key: 'close-left',
      icon: () => h('i', { class: 'icon-ant-design:swap-left-outlined' }),
    },
    {
      label: '关闭右侧',
      key: 'close-right',
      icon: () => h('i', { class: 'icon-ant-design:swap-right-outlined' }),
    },
    {
      label: '关闭所有',
      key: 'close-all',
